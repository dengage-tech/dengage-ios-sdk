...
final class CartViewController: UIViewController {
    ...
    private lazy var cartItemCountTextField: UITextField = {
        let view = UITextField()
        view.placeholder = "Cart Item Count"
        view.textAlignment = .center
        view.borderStyle = .roundedRect
        view.autocapitalizationType = .none
        view.delegate = self
    ...
    private lazy var cartAmountTextField: UITextField = {
        let view = UITextField()
        view.placeholder = "Cart Amount"
        view.textAlignment = .center
        view.borderStyle = .roundedRect
        view.autocapitalizationType = .none
        view.delegate = self
    ...
    private lazy var showButton: UIButton = {
        let view = UIButton()
        view.setTitle("Show Cart In App", for: .normal)
    ...
    private lazy var stackView: UIStackView = {
        let view = UIStackView(arrangedSubviews: [screenNameTextField, cartItemCountTextField, cartAmountTextField, addParameterButton, showButton])
        view.axis = .vertical
    ...
    @objc private func didTapShowButton(){
        // Cart bilgilerini ayarla
        if let itemCount = cartItemCountTextField.text, !itemCount.isEmpty {
            Dengage.setCart(itemCount: itemCount)
        }
        
        if let amount = cartAmountTextField.text, !amount.isEmpty {
        ...
        // Cart için Dengage method çağrısı
