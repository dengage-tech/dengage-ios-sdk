...
public class DengageLiveActivitiesManagerImpl: NSObject {
    ...
    public static func startDefault(_ activityId: String, attributes: [String: Any], content: [String: Any]) {
        ...
        var attributeData = [String: AnyCodableLiveActivity]()
        for attribute in attributes {
            attributeData.updateValue(AnyCodableLiveActivity(attribute.value), forKey: attribute.key)
        }

        var contentData = [String: AnyCodableLiveActivity]()
        for contentItem in content {
            contentData.updateValue(AnyCodableLiveActivity(contentItem.value), forKey: contentItem.key)
        }
