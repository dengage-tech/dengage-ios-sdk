...
final class DengageNotificationManagerInternal: NSObject {
    ...
    init(config: DengageConfiguration,
        ...
        DengageNotificationManagerInternal.notificationDelegate  = DengageNotificationDelegate.init(config: self.config, eventManager: self.eventManager)
