    ...
    struct Constants {
        ...
        static func createInAppMessage(with contentParams: ContentParams) -> InAppMessage{
            ...
            let data = InAppMessageData(messageDetailId: "messageDetails",
                                        ...
                                        priority: .high,
                                        content: content,
                                        displayCondition: .init(screenNameFilters: [], ruleSet: nil, screenNameFilterLogicOperator: .AND), displayTiming: .init(delay: 0,
                                                                                                                           showEveryXMinutes: 0,
                                                                                                                                                                maxShowCount: 1, maxDismissCount: 0), publicId: nil, inlineTarget: .init(iosSelector: "hgh"), abTest: nil)
