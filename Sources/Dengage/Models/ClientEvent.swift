...
struct ClientEvent: Codable {
    ...
    init(tableName: String, eventType: String, key: String?, eventDetails: [String: Any], timestamp: TimeInterval = Date().timeIntervalSince1970) {
    ...
    enum CodingKeys: String, CodingKey {
        case tableName, eventType, key, eventDetails, timestamp
    }
}
